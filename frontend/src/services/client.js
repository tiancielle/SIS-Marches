...
async function request(path, { isForm, ...options } = {}) {
...
export const api = {
  ...
  // Upload de fichier (multipart/form-data) : on NE fixe PAS Content-Type nous-même,
  // le navigateur doit poser le boundary lui-même à partir du FormData.
